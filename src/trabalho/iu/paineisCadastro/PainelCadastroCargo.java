...
public class PainelCadastroCargo extends JPanel implements ActionListener
{
	...
	public PainelCadastroCargo(BancoDeDados bd)
	{
		bancoDeDados = bd;
	...
	{		
		String sql = "INSERT INTO cargo (nome) values ('" + jtfNome.getText() + "')";
		try {
			check();
