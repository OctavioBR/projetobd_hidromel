...
ALTER TABLE medicao ADD CONSTRAINT FK_medicao_fermentacao FOREIGN KEY (idFermentacao) REFERENCES fermentacao (id) ON UPDATE CASCADE;
ALTER TABLE investidor ADD CONSTRAINT FK_pessoa_investidor FOREIGN KEY (idPessoa) REFERENCES pessoa (id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE pessoa_fisica ADD CONSTRAINT FK_pessoafisica_pessoa FOREIGN KEY (idPessoa) REFERENCES investidor (idPessoa) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE pessoa_juridica ADD CONSTRAINT FK_pessoajuridica_pessoa FOREIGN KEY (idPessoa) REFERENCES investidor (idPessoa) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE socio ADD CONSTRAINT FK_socio_pessoafisica FOREIGN KEY (idPessoa) REFERENCES pessoa_fisica (idPessoa) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE funcao ADD CONSTRAINT FK_funcao_socio FOREIGN KEY (idSocio) REFERENCES socio (idPessoa) ON UPDATE CASCADE;
ALTER TABLE funcao ADD CONSTRAINT FK_funcao_cargo FOREIGN KEY (idCargo) REFERENCES cargo (id) ON UPDATE CASCADE;
ALTER TABLE funcao ADD CONSTRAINT FK_funcao_departamento FOREIGN KEY (idDepartamento) REFERENCES departamento (id) ON UPDATE CASCADE;
ALTER TABLE local ADD CONSTRAINT FK_local_socio FOREIGN KEY (idSocio) REFERENCES socio (idPessoa) ON UPDATE CASCADE;
ALTER TABLE compra_insumo ADD CONSTRAINT FK_comprainsumo_fornecedor FOREIGN KEY (idFornecedor) REFERENCES fornecedor (id);
ALTER TABLE compra_insumo ADD CONSTRAINT FK_comprainsumo_insumo FOREIGN KEY (idInsumo) REFERENCES insumo (id);
ALTER TABLE maturacao ADD CONSTRAINT FK_maturacao_local FOREIGN KEY (idLocal) REFERENCES local (id) ON UPDATE CASCADE;
...
ALTER TABLE receita ADD CONSTRAINT FK_receita_autor FOREIGN KEY (idPessoa) REFERENCES pessoa (id) ON UPDATE CASCADE;
